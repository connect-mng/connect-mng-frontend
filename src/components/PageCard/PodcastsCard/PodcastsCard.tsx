...
import "./PodcastsCard.desktop.css";
import "./PodcastsCard.mobile.css";
...
export default function PodcastsCard({
  ...
  return (
    ...
    >
      ...
      {pillText ? (
          <div className="podcastsHeroCard__pill podcastsHeroCard__pill--mobile">
            {pillText}
          </div>
        ) : null}
        ...
        {pillText ? (
            <div className="podcastsHeroCard__pill podcastsHeroCard__pill--desktop">
              {pillText}
            </div>
          ) : null}
