...
const translations = {
    en: {
        ...
        homeCardTitle: "Empowering Mongolian American to Connect, Learn, and Thrive",
        homeCardDesc: "Connect MNG is dedicated to empowering Mongolian American college students and young professionals by fostering a strong sense of community, providing tailored resources for personal and professional growth, and cultivating an environment where individuals can connect, learn, and thrive together.",
        ourStoryPillText: "By Mongolians, For Mongolians",
        ourStoryText2: "We started Connect MNG because each of us once faced these struggles alone—navigating a foreign space of opportunities, yet searching for connection and support. We don't want the next generation of Mongolian Americans students and young professionals to experience that isolation. Instead, we want them to feel supported, connected, and empowered to thrive both personally and professionally.",
        joinOurCommunity: "Join Our Community",
        ourStoryTextmission: "Our mission is empowering the Mongolian American college students & young professionals’ success by fostering a strong sense of community providing tailored resources for personal and professional growth, and cultivating an environment where individuals can connect, learn, and thrive together.",
        meetTheTeam: "Meet the Team",
        ourTeamDesc: "Passionate individuals dedicated to empowering the Mongolian American community through meaningful programs, events, and connections",
        ...
        donatePillText: "Support Our Community",
        donateCardTitle: "Donate",
        donateCardBody: "Your contribution empowers Mongolian American college students and young professionals to thrive. Every donation directly funds free programs, mentorship opportunities, and community events that foster growth and connection.",
        eventsPillText: "Connect & Grow Together",
        eventsCardBody: "Join Connect MNG for networking events, professional development workshops, career panels, and social gatherings. Build meaningful connections with fellow Mongolian American students and professionals while growing your skills and network.",
        blogsCardBody: "By our community, for our community",
        ourValuesTitle: "Our Values",
        ourStoryCardTitle: "Our Story",
        ourStoryCardBody: "We started Connect MNG because each of us once faced these struggles alone—navigating a foreign space full of opportunities, yet searching for connection and support. We don't want the next generation of Mongolian American students and young professionals to experience that isolation. Instead, we want them to feel supported, connected, and empowered to thrive both personally and professionally.",
